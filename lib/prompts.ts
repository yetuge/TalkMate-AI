...
export function buildCorrectionPrompt({
  ...
  return [
    ...
    "Good output:",
    '{"feedbackType":"CONTEXT_VALID","originalText":"specific cuisine","recommendedExpression":"A specific cuisine.","reason":"This reply is understandable and natural in the current context. A small article makes it sound a bit more polished.","scores":{"grammar":88,"fluency":88,"vocabulary":85,"pronunciation":86}}',
    "Bad output:",
    ...
    "Good output:",
    '{"feedbackType":"CORRECTION","originalText":"do you have any recommendation","recommendedExpression":"Do you have any recommendations?","reason":"Here, recommendations is more natural because you are asking for suggestions in general.","scores":{"grammar":82,"fluency":84,"vocabulary":82,"pronunciation":84}}',
    "Example 3:",
    'assistantMessage: "Would you like coffee or tea?"',
    'userMessage: "coffee"',
    "Good output:",
    '{"feedbackType":"CONTEXT_VALID","originalText":"coffee","recommendedExpression":"Coffee, please.","reason":"This is a valid short answer in context. Adding please makes it sound a bit more polite.","scores":{"grammar":90,"fluency":90,"vocabulary":86,"pronunciation":88}}',
  ].join("\n");
}
